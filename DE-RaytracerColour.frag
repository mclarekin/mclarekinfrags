#donotrun
// this is DE-Raytracer hacked for a color trial. mclarekin 21-09-2017
#include "3D.frag"
...
uniform float OrbitStrength; slider[0,1,1]
...
// Vignette background
uniform float GradientBackground; slider[0.0,0.0,5.0]
